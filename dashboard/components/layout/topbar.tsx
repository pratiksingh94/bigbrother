...
export default function Topbar() {
    ...
    return (
        <header className="flex h-14 items-center justify-between border-b border-border px-6">
            ...
            <div className={cn("flex items-center gap-1.5 rounded-full border px-2.5 py-0.5 text-xs", backendOnline === null ? "border-border text-muted-foreground" : backendOnline ? "border-primary/30 text-primary" : "border-destructive/30 text-destructive")}>
